import time #Importamos la librería time dónde encontraremos la función de sleep.
...
if __name__ == '__main__':
    while True:
        ...
        time.sleep(240) #Indicamos a Python que espere 240 segundos, tras ese tiempo se ejecutará de nuevo el while
